---
layout: pages
title: Implementing New Workloads
---
h2. Overview
...
Creating a new file that changes any of these values will produce a new workload with different characteristics. The set of properties that can be specified is in [[Core Properties]].
