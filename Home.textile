...
<ul>
<LI><a href="http://twiki.corp.yahoo.com/view/YDHT/WebHome">Sherpa</a>
<LI>BigTable
<ul>
...
on the same hardware configuration, and run the same workloads against each system. Then you can plot the performance 
