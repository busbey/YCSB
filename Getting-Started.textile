...
| 0.1.2 | <A HREF="http://github.com/brianfrankcooper/YCSB/tarball/0.1.2">[.tar.gz]</A> | <A HREF="http://github.com/brianfrankcooper/YCSB/zipball/0.1.2">[.zip]</A> |
...
First, you must obtain the clients for each system.<P>
  ...
  * MongoDB: <A HREF="http://www.mongodb.org/">http://www.mongodb.org/</A> - YCSB has been built with version 1.4.2
...
Similar steps are required for MongoDB.
...
At the end of this process, the ycsb.jar file in the build/ directory will contain all the classes needed to run YCSB, as well as the Cassandra,0  HBase and MongoDB connector classes.
